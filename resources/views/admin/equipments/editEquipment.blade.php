                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="p-2 ">
                                    ...
                                    <input type="text" id="name" name="name" value="{{$equipment->name}}" placeholder="Equipment Name" class="d-block w-100 p-2" required>
                                </div>
                                <div class="p-2 ">
                                    <label class="pb-2" for="description">Equipment Description</label>
                                    <input type="textarea" id="description" name="description" value="{{$equipment->description}}" placeholder="Description" autocomplete="off" class="d-block w-100 p-2" required>
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="p-2 ">
                                    ...
                                    <input type="text" id="v_name" name="v_name" value="{{$equipment->vendor}}" placeholder="Vendor Name" class="d-block w-100 p-2" required>
                                </div>
                                <div class="p-2 ">
                                    <label class="pb-2" for="address">Address</label>
                                    <input type="text"  name="address" value="{{$equipment->address}}" placeholder="Address" class="d-block w-100 p-2" required>
                                </div>
                                <div class="p-2 ">
                                    <label class="pb-2" for="contact">Contact Number</label>
                                    <input type="tel"  name="contact" value="{{$equipment->contact}}" placeholder="Contact Number" class="d-block w-100 p-2" required>
                                </div>

                                {{-- Contact Information --}}
                                <h3 class="text-center mt-3" >Pricing Details</h3>
                                <div class="p-2 ">
                                    <div class="cost">
